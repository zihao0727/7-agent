...
import { Wrench, Zap, Server, ChevronLeft } from "lucide-react";
import { ToolsPanel } from "./panels/ToolsPanel";
import { SkillsPanel } from "./panels/SkillsPanel";
import { MCPPanel } from "./panels/MCPPanel";

type TabId = "tools" | "skills" | "mcp";
  ...
  return (
    <aside className={`flex flex-col flex-shrink-0 border-r border-gray-200 dark:border-gray-700
      ...
      <div className="px-4 py-3 border-b border-gray-200 dark:border-gray-700 flex-shrink-0 flex items-center justify-between">
        <div>
          <h2 className="text-sm font-semibold text-gray-900 dark:text-gray-100">配置面板</h2>
          <p className="text-xs text-gray-400 mt-0.5">管理工具、技能和 MCP 服务器</p>
        </div>
        <button
